...
const Cart = () => {
  ...
  const totalPrice = cartItems.reduce((acc, item) => acc + (item.price*50).toFixed(0) * item.qty, 0);

  return (
    <div className="cart-container">
      <h2 style={{ color: '#f97316', background: 'none', WebkitTextFillColor: '#f97316' }}>Shopping Cart</h2>
      {cartItems.length === 0 ? (
